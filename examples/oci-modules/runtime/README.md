...
Core suite runtime module exposing container.run/create/get, mock.serve, service.wiremock/prism/custom, script, load, and scenario entry points for topology orchestration.
...
See `usage.star`, `suite_example.star`, `scripts/container_lifecycle.star`, `scripts/mock_lifecycle.star`, `scripts/service_lifecycle.star`, `scripts/script_results.star`, `load_reports.star`, and `scenario_reports.star` for the recommended runtime patterns.
